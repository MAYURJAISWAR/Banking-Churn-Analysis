...
3) Created an interactive dashboard using various visualizations to analyze the data, revealing that customers with non-credit accounts and lower salaries were the biggest churners. This analysis helped RBC improve customer retention strategies and increase revenue.
